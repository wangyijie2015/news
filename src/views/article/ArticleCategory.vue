...
// 声明一个异步的函数s
import { articleCategoryListService,articleCategoryDeleteService,articleCategoryAddService,articleCategoryUpdateService } from '@/api/article.js'
...
const rules = {
    ...
    categoryAlias: [
        { required: true, message: '请输入分类的别名', trigger: 'blur' },
    ]
}
        ...
        <el-table :data="categorys" style="width: 100%">
            ...
            <el-table-column label="操作" width="100">
                <template #default="{ row }">
                    <el-button :icon="Edit" circle plain type="primary" @click="updateCategoryEcho" ></el-button>
